...
// Install a minimal vue-i18n globally so any component calling useI18n()
// resolves against it. See `createTestI18n` for why this stays separate from
// the real @/i18n module (it would eagerly pull @/api and cache a Tauri mock
// the back-button tests replace).
