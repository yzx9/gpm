...
# (`register_android_plugin("xyz.yzx9.gpm.securekeystore", "SecureKeystorePlugin")`),
...
-keep class xyz.yzx9.gpm.securekeystore.SecureKeystorePlugin {
  public <init>(...);
  @app.tauri.annotation.Command <methods>;
}

# The @InvokeArg argument holder is deserialized by field name — keep all members.
-keep class xyz.yzx9.gpm.securekeystore.StoreArgs {
  *;
}
