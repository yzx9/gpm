...
# annotated with @TauriPlugin / @Command, so no per-plugin rules are needed here
# beyond keeping the @InvokeArg argument holder (covered by default Android
# build rules for classes referenced reflectively).
