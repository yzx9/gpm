...
pub use store::{
    CommitIdentity, DivergenceChoice, EntryConflictChoice, ExpectedEntry, ExpectedKind,
    GpgIdentityPreview, RankedPage, RevisionContent, Store, SyncDivergence, SyncOutcome,
    SyncResult, WriteOutcome, WriteResult, clamp_lock_mode, normalize_clear_secs,
};
